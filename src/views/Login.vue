        ...
        <div class="d-flex flex-column align-items-center">
          <div class="d-flex">
            <img
              ...
              alt="company logo"
            />
            <h2>RO-ED LOGISTICS SERVICES</h2>
          </div>
          <h3 class="mb-5">Trucking Management System</h3>
        </div>
        <form @submit.prevent="onLogin" class="w-75 d-flex flex-column gap-3">
